...
@Component({
  selector: 'epay-invoice-data-table',
...
export class InvoiceDataTableComponent {
  ...
  displayedColumns: string[] = [
    'select', 'status', 'invoiceNumber', 'creditNumber', 'shipTo',
    'invoiceDate', 'orderNumber', 'tripNumber', 'rppNumber', 'poNumber',
    'invoiceAmount', 'amountPaid', 'balance', 'code', 'days'
  ];
